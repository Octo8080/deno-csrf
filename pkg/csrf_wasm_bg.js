...
export function generateAesGcmTokenPair(aead_key, ttl_seconds) {
    const ptr0 = passStringToWasm0(aead_key, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
...
export function verifyAesGcmTokenPair(aead_key, token_str, cookie_str) {
    const ptr0 = passStringToWasm0(aead_key, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(token_str, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
    const ptr2 = passStringToWasm0(cookie_str, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
